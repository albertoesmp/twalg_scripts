...
#        conduct an ablation study on the features for the motorbike dataset.
#
# FEATURE IMPORTANCES:
# mean_curv_full_r0_6             ,             0.013080
# gauss_curv_full_r0_6            ,             0.013395
# full_gauss_umbilicality_r0_6    ,             0.015142
# full_rmsc_r0_6                  ,             0.015300
# full_shape_index_r0_6           ,             0.016203
# full_abs_algdist_r0_6           ,             0.020605
# full_gradient_norm_r0_6         ,             0.024862
# full_normalized_gac_r0_6        ,             0.027207
# full_laplacian_r0_6             ,             0.045313
# saddleness_r0_6                 ,             0.055398
# full_quad_dev_r0_6              ,             0.059030
# ---------------------------------------------------------------------------- #


# ---  CONSTANTS  --- #
# ------------------- 3
REF_TRAINING_JSON='/home/uadmin/git/twalg_scripts/shapenet/experiments/fixed/motorbike_training_second_order.json'
REF_VAL_JSON='/home/uadmin/git/twalg_scripts/shapenet/experiments/fixed/motorbike_validation_second_order.json'
...
TMP_TRAIN_JSON='tmp_ablation_training_motorbike.json'
TMP_VAL_JSON='tmp_ablation_predict_motorbike.json'
RADII=(
    "0.06"
    "0.1"
    "0.3"
...
OUTDIR='/ext4/lidar_data/shapenet/vl3d/out/motorbike/ablation/'
...
EOF
    ...
    cat << EOF >> ${TMP_TRAIN_JSON}
        {
            "writer": "Writer",
            "out_pcloud": "*/training_motorbike.las"
        },
        {
            ...
            "training_data_pipeline": [
                {
                    ...
                    "component_args": {
                        "target_class_distribution": [2000000, 2000000, 2000000, 2000000, 2000000, 0],
                        "replace": false
                    }
                }
            ]
...
EOF
    ...
    "sequential_pipeline": [
        ...
        },
        {
            ...
            "class_names": ["wheel", "handle", "gas_tank", "light", "seat", "other"],
