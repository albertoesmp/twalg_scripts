...
# BRIEF: Experiment with the randomized guitar dataset                       #
# ---------------------------------------------------------------------------- #
...
# ---   MAIN   --- #
# ---------------- #
# Recopilate guitar point clouds
find_pclouds
