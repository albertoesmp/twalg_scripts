...
#        conduct an ablation study on the features for the pistol dataset.
#
# FEATURE IMPORTANCES:
# gauss_curv_full_r0_6            ,             0.015244
# full_rmsc_r0_6                  ,             0.015557
# full_gauss_umbilicality_r0_6    ,             0.015796
# mean_curv_full_r0_6             ,             0.016087
# full_abs_algdist_r0_6           ,             0.016663
# full_normalized_gac_r0_6        ,             0.018087
# full_gradient_norm_r0_6         ,             0.021372
# full_shape_index_r0_6           ,             0.030641
# full_laplacian_r0_6             ,             0.047198
# saddleness_r0_6                 ,             0.051963
# full_quad_dev_r0_6              ,             0.062237
#
# ---------------------------------------------------------------------------- #
...
# ---  CONSTANTS  --- #
# ------------------- 3
REF_TRAINING_JSON='/home/uadmin/git/twalg_scripts/shapenet/experiments/fixed/pistol_training_second_order.json'
REF_VAL_JSON='/home/uadmin/git/twalg_scripts/shapenet/experiments/fixed/pistol_validation_second_order.json'
...
TMP_TRAIN_JSON='tmp_ablation_training_pistol.json'
TMP_VAL_JSON='tmp_ablation_predict_pistol.json'
RADII=(
    "0.06"
    "0.1"
    "0.3"
...
OUTDIR='/ext4/lidar_data/shapenet/vl3d/out/pistol/ablation/'
...
EOF
    ...
    cat << EOF >> ${TMP_TRAIN_JSON}
        {
            "writer": "Writer",
            "out_pcloud": "*/training_pistol.las"
        },
        {
...
EOF
    ...
    "sequential_pipeline": [
		...
		},
        {
            ...
            "class_names": ["trigger_and_guard", "handle", "barrel", "other"],
