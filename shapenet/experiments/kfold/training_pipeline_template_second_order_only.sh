...
cat << EOF >> "${VL3DPIPE}"
        ...
        },
        {
            ...
            "frenames": [
                "gauss_curv_full_r0_6", "mean_curv_full_r0_6", "full_quad_dev_r0_6", "full_abs_algdist_r0_6", "full_gradient_norm_r0_6",
                "full_laplacian_r0_6", "full_rmsc_r0_6", "full_gauss_umbilicality_r0_6", "full_shape_index_r0_6", "saddleness_r0_6",
                "full_normalized_gac_r0_6"
            ],
            "non_degenerate_eigenthreshold": 0.00001,
            "tikhonov_parameter": 0.0000001,
            "nthreads": -1
