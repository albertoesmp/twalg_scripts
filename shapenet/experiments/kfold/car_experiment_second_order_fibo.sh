...
# BRIEF: Experiment with the randomized car dataset                            #
# ---------------------------------------------------------------------------- #
...
VL3DPIPE='/tmp/vl3d_car_stratkfold.json'
# Directory where the point clouds of the dataset are located
DATADIR='/ext4/lidar_data/shapenet/pcloud/Car'
# Output directory for the pipeline
OUTDIR='/ext4/lidar_data/shapenet/vl3d/out/car/order2_fibo/'
# Output file for point cloud with mined features
OUTFEATS='training_car.las'
# Output file to store the trained model
OUTMODEL='rf_car.pipe'
