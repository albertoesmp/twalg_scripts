...
#        conduct an ablation study on the features for the chair dataset.
#
# FEATURE IMPORTANCES:
# mean_curv_full_r0_6             ,             0.016207
# full_shape_index_r0_6           ,             0.016625
# full_abs_algdist_r0_6           ,             0.019371
# full_gauss_umbilicality_r0_6    ,             0.024849
# full_rmsc_r0_6                  ,             0.028033
# full_laplacian_r0_6             ,             0.028113
# saddleness_r0_6                 ,             0.028149
# gauss_curv_full_r0_6            ,             0.029457
# full_quad_dev_r0_6              ,             0.036959
# full_normalized_gac_r0_6        ,             0.081988
# full_gradient_norm_r0_6         ,             0.082478
#
# ---------------------------------------------------------------------------- #
...
# ---  CONSTANTS  --- #
# ------------------- 3
REF_TRAINING_JSON='/home/uadmin/git/twalg_scripts/shapenet/experiments/fixed/chair_training_second_order.json'
REF_VAL_JSON='/home/uadmin/git/twalg_scripts/shapenet/experiments/fixed/chair_validation_second_order.json'
...
TMP_TRAIN_JSON='tmp_ablation_training_chair.json'
TMP_VAL_JSON='tmp_ablation_predict_chair.json'
RADII=(
    "0.06"
    "0.1"
    "0.3"
...
OUTDIR='/ext4/lidar_data/shapenet/vl3d/out/chair/ablation/'
            ...
            "training_data_pipeline": [
                {
                    ...
                    "component_args": {
                        "target_class_distribution": [2000000, 2000000, 2000000, 2000000, 0],
                        "replace": false
                    }
                }
            ]
...
EOF
    ...
    "sequential_pipeline": [
        ...
        },
        {
            ...
            "class_names": ["leg", "arm", "back", "seat", "other"],
