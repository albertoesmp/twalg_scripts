...
# BRIEF: Experiment with the randomized chair dataset                       #
# ---------------------------------------------------------------------------- #
...
VL3DPIPE='/tmp/vl3d_chair_stratkfold.json'
# Directory where the point clouds of the dataset are located
DATADIR='/ext4/lidar_data/shapenet/pcloud/Chair'
# Output directory for the pipeline
OUTDIR='/ext4/lidar_data/shapenet/vl3d/out/chair/order2_fibo/'
# Output file for point cloud with mined features
OUTFEATS='training_chair.las'
# Output file to store the trained model
OUTMODEL='rf_chair.pipe'
