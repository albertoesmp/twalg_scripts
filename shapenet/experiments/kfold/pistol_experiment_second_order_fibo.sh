...
# BRIEF: Experiment with the randomized pistol dataset                       #
# ---------------------------------------------------------------------------- #
...
VL3DPIPE='/tmp/vl3d_pistol_stratkfold.json'
# Directory where the point clouds of the dataset are located
DATADIR='/ext4/lidar_data/shapenet/pcloud/Pistol'
# Output directory for the pipeline
OUTDIR='/ext4/lidar_data/shapenet/vl3d/out/pistol/order2_fibo/'
# Output file for point cloud with mined features
OUTFEATS='training_pistol.las'
# Output file to store the trained model
OUTMODEL='rf_pistol.pipe'
...
TRAINING_DISTRIBUTION='[2000000, 2000000, 2000000, 0]'
...
# ---   MAIN   --- #
# ---------------- #
# Recopilate pistol point clouds
find_pclouds
